...
> [!TIP]
> Hãy vào đường link `http://localhost:3000/home` (nên mở bằng chế độ Mobile (F12) trên Chrome) để chiêm ngưỡng giao diện bảng điều khiển chính thức nhé! Trang Landing (`/`) vẫn giữ nguyên chức năng chào mừng.
